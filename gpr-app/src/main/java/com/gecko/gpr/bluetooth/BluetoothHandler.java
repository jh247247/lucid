...
/**
 * This file handles the connection to the bluetooth device, at a higher abstraction layer to the
 *
 */
...
public class BluetoothHandler {
    ...
    public BluetoothHandler(Context context, Listener listener) {
        this(context, ConnectionTo.OTHER_DEVICE, Connection.SECURE, listener);
    }

    public BluetoothHandler(Context context, ConnectionTo connectionTo, Connection connection,
                           Listener listener) {
        mContext = context;
        mListener = listener;
