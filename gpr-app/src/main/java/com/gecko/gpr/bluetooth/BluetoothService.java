...
/**
 * This class handles the android bluetooth stack, creating threads to connect, accept connections and handle incoming
 * data.
 * Adapted from the bluetooth chat service, given at: https://developer.android.com/samples/BluetoothChat/src/com.example.android.bluetoothchat/BluetoothChatService.html
 */
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MESSAGE_READ, -1, -1, ByteBuffer.wrap(buffer,0,bytes))
                        .sendToTarget();
                } catch (IOException e) {
                    connectionLost();
                    // Start the service over to restart listening mode
